...
var CryptoJS = CryptoJS || function (q, k) {
    var e = {}, l = e.lib = {}, p = function () {
        ...
        u = l.BufferedBlockAlgorithm = c.extend({reset: function () {
    ...
    l.Hasher = u.extend({cfg: c.extend(), init: function (a) {
...
CryptoJS.lib.Cipher || function (q) {
    ...
    var a = k.mode = {}, t = function (a, b, c) {
        ...
        for (var e = 0; e < c; e++)a[b + e] ^=
            d[e]
    }, u = (e.BlockCipherMode = l.extend({createEncryptor: function (a, b) {
    ...
    u.Encryptor = u.extend({processBlock: function (a, b) {
        var c = this._cipher, d = c.blockSize;
        t.call(this, a, b, d);
        c.encryptBlock(a, b);
        this._prevBlock = a.slice(b, b + d)
    }});
    u.Decryptor = u.extend({processBlock: function (a, b) {
    ...
    a = a.CBC = u;
    u = (k.pad = {}).Pkcs7 = {pad: function (a, b) {
    ...
    e.BlockCipher = d.extend({cfg: d.cfg.extend({mode: a, padding: u}), reset: function () {
        d.reset.call(this);
