...
var DlgZpmjMain = DlgBase.extend({
	...
	init: function() {		
        ...
        cc.log("test======2222222222222222222222");
		...
		// 初始化抓花数
        this.Text_room_getFlowers = this.Panel_roomInfo.getChildByName("Text_room_getFlowers");
        this.Text_room_getFlowers.string = "抓花数：" + game.getZhuaHuaCnt();
        cc.log("抓花数："+game.getZhuaHuaCnt());
