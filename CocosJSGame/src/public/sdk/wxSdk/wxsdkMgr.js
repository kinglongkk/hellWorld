...
gg.WxSdkMgr = cc.Class.extend({
	...
	javaCallWxLoginSucc: function(code){
		...
		var url = 'http://'+ _CONFIG_.LOGON_WCHAT + ":" + _CONFIG_.WXLOGON_PORT+ '/login?code='+code + '&' + 'channeltype=' + _CONFIG_.channeltype;
		var args = 'code=' + code;
		var _self = this;
	...
	GetUserDataFromWeb:function()
	{
		...
		url = "http://zyd769.f3322.net:20001/pay/wxnotify"
		var args = postData;
