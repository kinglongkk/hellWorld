...
var HttpRequest = cc.Class.extend({
	...
	streamXHREvents: function(xhr){
		...
		xhr.onerror = function () {
			DlgTip.openSysTip("请求数据失败，请联系客服！");
		}
		
		xhr.ontimeout = function () {
			DlgTip.openSysTip("请求数据超时，请联重新尝试！");
		}
	},
...
HttpRequest.getInstance = function() {
	if (!s_sharedHttpRequest) {
		s_sharedHttpRequest = new HttpRequest();
	}
	return s_sharedHttpRequest;
};
