...
// 		this.ImgBarBg = this.PanelBg.getChildByName('ImgBarBg');
//
// 		this.LabTip = this.PanelBg.getChildByName('LabTip');
//         this.LabTip.setFontSize(22);
//
...
//         this.WaitNode.setPosition(sizeDir.width/2.0, sizeDir.height/2.0);
//         this.Text_tip = widget.getChildByName("Text_tip");
//         this.Text_tip.string = "";
...
//
// 		this.ImgBarBg.setVisible(false);
// 		this.ProgressBar.setVisible(false);
// 		//this.LabPercent.setVisible(false);
//
