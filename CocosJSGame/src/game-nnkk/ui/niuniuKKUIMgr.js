var s_sharedNiuniuKKUIMgr = null;

var NiuniuKKUIMgr = GameUIMgr.extend({
    resetData: function () {
...
NiuniuKKUIMgr.getInstance = function () {
    if (!s_sharedNiuniuKKUIMgr) {
        s_sharedNiuniuKKUIMgr = new NiuniuKKUIMgr();
    }
    return s_sharedNiuniuKKUIMgr;
};
