var NiuniuKKMainLayer = cc.Layer.extend({
...
var NiuniuKKScene = cc.Scene.extend({
    ctor: function () {
        this._super();
        this.init();
        ...
        this.layer = new NiuniuKKMainLayer();
        this.addChild(this.layer);
        this.layer.init();

        //游戏管理
        var gameUIMgr = NiuniuKKUIMgr.getInstance();
    ...
    onEnterTransitionDidFinish: function () {
        ...
        NiuniuKKUIMgr.getInstance().init(this.layer);
    },
