...
cc.log("--------ID_DlgZpmjResult = "  + ID_DlgZpmjResult);
DLG_CREATOR[ID_DlgZpmjResult] = function() {
	return new DlgZpmjResult();
};

var DlgZpmjResult = DlgBase.extend({
	//成员函数
	ctor: function(){	
	...
	init: function() {		
		// 初始变量设定
		var json = ccs.load(res.zpmjDlgResult_json);
