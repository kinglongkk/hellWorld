                ...
                <tr class="tab-detail">
                    ...
                    <td>
                        <div class="joy-list-row-operations text_c">
                            <a href="/playerDataStatistics/ownerPlayerList.html?search.startTime=${soulFn:formatDateTz(p.betDate, DateFormat.DAY, timeZone)}&search.gameId=${p.gameId}&search.gameModelId=${p.gameModelId}" nav-target="mainFrame">
                                查看
                            </a>
                        </div>
                    </td>
