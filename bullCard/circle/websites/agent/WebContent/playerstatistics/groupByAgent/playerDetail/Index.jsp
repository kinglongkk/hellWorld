...
<div class="row">
    <form:form action="${root}/playerDataStatistics/playerDetailList.html" method="post">
        ...
        <form:hidden path="search.roomId" value="${command.roomId}" />
...
<!--//region your codes 3-->
<soul:import res="site/playerstatistics/groupByAgent/playerDetail/List"/>
