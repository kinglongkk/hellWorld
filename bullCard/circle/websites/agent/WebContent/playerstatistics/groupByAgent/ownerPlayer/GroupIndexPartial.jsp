                ...
                <tr class="tab-detail">
                    ...
                    <td>
                        <div class="joy-list-row-operations text_c">
                            <a href="/playerDataStatistics/playerDetailList.html?search.startTime=${soulFn:formatDateTz(p.betDate, DateFormat.DAY, timeZone)}&search.sysUserId=${p.sysUserId}&search.gameId=${p.gameId}&search.gameModelId=${p.gameModelId}&search.roomId=${p.roomId}" nav-target="mainFrame">
                                查看
                            </a>
                        </div>
                    </td>
