...
<body>
    <form:form method="post">
        ...
        <div class="modal-body">
            ...
            <div class="form-group over clearfix">
                <label class="col-xs-3 al-right line-hi34">${views.column['player.view.remark.remarkTitle']}：</label>
                <div class="input-group m-b col-xs-9">
                    <form:input class="form-control" path="result.remarkTitle" value="${result.remarkTitle}" maxlength="100"/>
                </div>
            </div>
            <div class="form-group over clearfix">
                <label class="col-xs-3 al-right line-hi34">${views.column['player.view.remark.remarkContent']}：</label>
                <div class="input-group m-b col-xs-9">
