        ...
        <div class="wrapper white-bg shadow">
            <ul class="artificial-tab clearfix bg-gray m-t">
                <c:forEach items="${vSysAnnouncementListVo.result}" var="v" varStatus="ide">
                    ...
                    <c:if test="${vSysAnnouncementListVo.result.size()==1}">
                        <li class="m-l-lg">
                            <a href="/vSysAnnouncement/editNotice.html?search.id=${vSysAnnouncementListVo.result[0].id}"  nav-target="mainFrame"
...
<soul:import res="site/announcement/SysNoticeDetail"/>
