    ...
    <div class="col-lg-12 m-b">
        <div class="wrapper white-bg shadow">
            ...
            <div class="operate-btn ">
                <a href="/vGameAnnouncement/gameNotice.html" nav-target="mainFrame" class="btn btn-outline btn-filter btn-lg ">${messages.common['operation.continueOperation']}</a>
                <a href="/vGameAnnouncement/gameNoticeHistory.html" nav-target="mainFrame" class="btn btn-outline btn-filter btn-lg ">${messages.common['operation.showNotes']}</a>
            </div>
        </div>
    </div>
</div>