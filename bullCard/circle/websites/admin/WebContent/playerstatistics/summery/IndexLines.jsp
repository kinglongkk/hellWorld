...
<!--//region your codes 1-->
<form:form action="${root}/playerSummery/indexLines.html" method="post">
        ...
        <div class="panel-body">
            ...
            <div class="row border-b-1">
                <div style="padding:0 0 20px 20px;">
                    ...
                    代理商:
                    <select name="agent" style="height: 34px; border-radius: 3px;"  multiple="multiple">
                        <c:forEach items="${listAgent}" var="i" varStatus="j">
                            <option value="${i.id}@@@${i.username}" <c:if test="${j.index==0}">selected</c:if>  >${i.username}</option>
                        </c:forEach>
                    </select>
            ...
            <div class="search-list-container">
                <%@ include file="IndexLinesPartial.jsp" %>
            </div>
