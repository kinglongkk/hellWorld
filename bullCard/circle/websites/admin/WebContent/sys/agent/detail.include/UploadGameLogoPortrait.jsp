...
<form:form>
    ...
    <div class="modal-body" style="height: 390px;">
        <div class="form-group clearfix">
            ...
            <div class="form-group m-b-sm">
                ...
                <input class="file" type="file" target="result.gameLogo" accept="image/*" />
                <input type="hidden" name="result.gameLogo" value="" />
    ...
    <div class="modal-footer">
        <soul:button cssClass="btn btn-filter" text="${views.common.OK}" opType="ajax" precall="myValidateForm"
                     target="${root}/userAgentGame/uploadLogoPortrait.html" dataType="json" post="getCurrentFormData"
...
<soul:import res="site/agent/GameLogo"/>
</html>