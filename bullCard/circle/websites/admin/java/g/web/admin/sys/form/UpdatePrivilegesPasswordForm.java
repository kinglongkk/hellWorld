...
public class UpdatePrivilegesPasswordForm implements IForm {
    ...
    @NotBlank
    @NotNull
//    @Remote(checkClass = MyAccountController.class, checkMethod = "checkPrivilegePassword", additionalProperties = {"password"}, message = "content.myAccount.updatePassword.error")
