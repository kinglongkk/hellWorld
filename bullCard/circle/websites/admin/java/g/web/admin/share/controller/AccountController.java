package g.web.admin.share.controller;
...
import g.web.admin.share.form.AccountOptionForm;
...
//        sendMessageByGroupCode(messageType, accountVo, accountVo.getGroupCode(), accountVo.getResult().getId(), eventType);
    ...
    private AccountVo createRemarkTitle(AccountVo accountVo, String viewsKey) {
        ...
        //获取备注标题
        String title = SessionManager.getUser().getUsername() + LocaleTool.tranView("role", viewsKey, new Object[]{role, accountVo.getResult().getUsername()});
