        ...
        bindEvent: function () {
            ...
            $(".row").on("change", "#game", function () {
                ...
                window.top.topPage.ajax({
                    type: "post",
                    url: root + "/playerDataStatistics/selectOwnerGameModel.html",
                    dataType: "json",
                    data: {
                        "gameId" : gameId
                    },
        ...
        bindClick: function () {
            ...
            if (isHidden <= 0) {
                ...
                $("#export").click(function(){
                    var url = root + '/playerDataStatistics/getAllGameExportData.html';
                    var form = document.getElementById("command");
                    form.action = url;
                    form.submit();
                    form.action = root + '/playerDataStatistics/allGameList.html';
                });
            }
        },
