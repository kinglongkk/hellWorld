        ...
        onPageLoad: function () {
            ...
            this.unInitFileInput($fileInput)
                .fileinput({
                    ...
                    msgImageWidthSmall: window.top.message.content['myAccount.file.size.widthError'],
                    msgImageHeightSmall: window.top.message.content['myAccount.file.size.heightError'],
                    msgImageWidthLarge: window.top.message.content['myAccount.file.size.widthError'],
                    msgImageHeightLarge: window.top.message.content['myAccount.file.size.heightError']
                });
