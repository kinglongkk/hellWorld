(function () {
    ...
    function boot () {
        ...
        var onStart = function () {
			...
			cc.game.config['myversion']='1.0.0.2';
            ...
            cc.AssetLibrary.init({
                libraryPath: G_urlEX.url_root+G_urlEX.url_image+'import',
                rawAssetsBase: G_urlEX.url_root+G_urlEX.url_image+'raw-',
        ...
        jsList = jsList.map(function (x) { return G_urlEX.url_root+G_urlEX.url_js + x; });
    ...
    if (window.document) {
        ...
        cocos2d.async = true;
        cocos2d.src = window._CCSettings.debug ? G_urlEX.url_root+G_urlEX.url_js+'cocos2d-js.js' : G_urlEX.url_root+G_urlEX.url_js+'cocos2d-js-min.js';
