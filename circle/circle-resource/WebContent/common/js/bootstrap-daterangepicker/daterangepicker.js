...
(function(root, factory) {
  ...
  // Finally, as a browser global.
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        this.startDate = moment().utcOffset(window.top.utcOffSet).startOf('day');
        this.endDate = moment().utcOffset(window.top.utcOffSet).endOf('day');
        ...
        if (typeof options.startDate === 'string')
            this.startDate = moment(options.startDate, this.locale.format).utcOffset(window.top.utcOffSet,true);

        if (typeof options.endDate === 'string')
            this.endDate = moment(options.endDate, this.locale.format).utcOffset(window.top.utcOffSet,true);

        if (typeof options.minDate === 'string')
            this.minDate = moment(options.minDate, this.locale.format).utcOffset(window.top.utcOffSet,true);

        if (typeof options.maxDate === 'string')
            this.maxDate = moment(options.maxDate, this.locale.format).utcOffset(window.top.utcOffSet,true);
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
            ...
            var curDate = moment([lastYear, lastMonth, startDay, 12, minute, second]).utcOffset(window.top.utcOffSet); // .utcOffset(this.timeZone);
