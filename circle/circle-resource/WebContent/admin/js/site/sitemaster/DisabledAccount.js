...
define(['common/BaseEditPage', 'bootstrapswitch'], function (BaseEditPage, Bootstrapswitch) {
    ...
    return BaseEditPage.extend({
        ...
        toConfirm:function(e){
            ...
            window.top.topPage.showConfirmDynamic(window.top.message.siteMaster['player.account.disabled.tipsTitle'],
                window.top.message.siteMaster['player.account.disabled.content'],window.top.message.setting['common.ok'],
