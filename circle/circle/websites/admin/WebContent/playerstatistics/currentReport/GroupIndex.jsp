...
<form:form action="${root}/currentReport/groupList.html" method="post">
        ...
        <div class="col-lg-12">
            <div class="wrapper white-bg shadow">
                <div class="clearfix filter-wraper border-b-1">
                    <div class="pull-left">
                        <a nav-target="mainFrame" href="/currentReport/groupList.html" class="btn btn-outline btn-filter">
                ...
                <div class="input-group filter-wraper">
                    ...
                    <div class="pull-left" style="padding-left: 12px;">
                        ...
                        <input type="text" class="form-control" name="search.ownerUsername" style="width: 200px;height: 34px; text-indent: 5px">
                    </div>
                    ...
                    <div class="pull-left" style="padding-left: 12px;">
                        ...
                        <input type="text" class="form-control" name="search.username" style="width: 200px;height: 34px; text-indent: 5px">
                    </div>
...
<!--//region your codes 3-->
<soul:import res="site/playerstatistics/currentReport/GroupList"/>
