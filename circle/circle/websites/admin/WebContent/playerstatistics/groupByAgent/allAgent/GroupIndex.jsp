...
<form:form action="${root}/playerDataStatistics/allAgentList.html" method="post">
        ...
        <div class="col-lg-12">
            <div class="wrapper white-bg shadow">
                <div class="clearfix filter-wraper border-b-1">
                    <div class="pull-left">
                        <a nav-target="mainFrame" href="/playerDataStatistics/allAgentList.html" class="btn btn-outline btn-filter">
...
<!--//region your codes 3-->
<soul:import res="site/playerstatistics/groupByAgent/allAgent/List"/>
