                ...
                <tr class="tab-detail">
                    ...
                    <td>
                        <div class="joy-list-row-operations text_c">
                            <a href="/playerDataStatistics/gameDetailList.html?search.startTime=${soulFn:formatDateTz(p.betDate, DateFormat.DAY, timeZone)}&search.ownerUsername=${p.ownerUsername}&search.sysUserId=${p.sysUserId}&search.gameId=${p.gameId}&search.gameModelId=${p.gameModelId}" nav-target="mainFrame">
                                查看
                            </a>
                        </div>
                    </td>
