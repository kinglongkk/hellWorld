...
<form:form action="${root}/playerWarningWinCount/winlist.html" method="post">
    <div id="validateRule" style="display: none">${command.validateRule}</div>
    <div class="row">
        <div class="position-wrap clearfix">
            <h2><a class="navbar-minimalize" href="javascript:void(0)"><i class="icon iconfont">&#xe610;</i> </a></h2>
            <span>预警</span><span>/</span><span>连赢派彩</span>
            <a href="/playerWarningWinCount/winlist.html" style="display: none" name="refresh" nav-target="mainFrame">${views.common['return']}</a>
        </div>
        <div class="col-lg-12">
            <div class="wrapper white-bg shadow">
                <div class="clearfix filter-wraper border-b-1">
                    <div class="pull-left">
                        <a nav-target="mainFrame" href="/playerWarningWinCount/winlist.html" class="btn btn-outline btn-filter"><i class="fa fa-refresh"></i><span class="hd">&nbsp;&nbsp;${views.common['refresh']}</span></a>
                        <label style="color: #2095f2;margin-left: 347px;">说明:每6分钟触发监控统计</label>
                    </div>
                            ...
                            <div class="input-group-btn">
                                <div selectdiv="" value="" class="btn-group chosen-select-no-single" initprompt="请选择" callback="selectListChange">
                                    ...
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                        ...
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="javascript:void(0)" key="search.num">连赢次数>=</a></li>
                                    </ul>
                                </div>
                            </div>
