...
//endregion your codes 1
	...
	/** 处置结束时间 */
	private java.util.Date disposeEndTime;
	/** 操作IP */
	private Long operateIp;
	/** 操作开始时间 */
	private java.util.Date operateStartTime;
	/** 操作结束时间 */
	...
	public java.util.Date getDisposeEndTime() {
		return this.disposeEndTime;
	}

	public void setDisposeEndTime(java.util.Date value) {
